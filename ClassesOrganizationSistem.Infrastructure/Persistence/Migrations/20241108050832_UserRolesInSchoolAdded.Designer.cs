...
namespace ClassesOrganizationSistem.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20241108050832_UserRolesInSchoolAdded")]
    partial class UserRolesInSchoolAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassesOrganizationSistem.Domain.Entities.UserEntites.SchoolRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ClassesOrganizationSistem.Domain.Entities.UserEntites.UserRoleInSchool", b =>
                {
            ...
            modelBuilder.Entity("ClassesOrganizationSistem.Domain.Entities.UserEntites.UserToSchool", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ClassesOrganizationSistem.Domain.Entities.RoomEntities.Equipment", b =>
                {
                    b.HasOne("ClassesOrganizationSistem.Domain.Entities.RoomEntities.Room", null)
                        .WithMany("Equipments")
            ...
            modelBuilder.Entity("ClassesOrganizationSistem.Domain.Entities.UserEntites.UserRoleInSchool", b =>
                {
                    ...
                    b.HasOne("ClassesOrganizationSistem.Domain.Entities.UserEntites.SchoolRole", "SchoolRole")
                        .WithMany()
            ...
            modelBuilder.Entity("StudentsClassUser", b =>
                {
                    b.HasOne("ClassesOrganizationSistem.Domain.Entities.StudentsClass", null)
                        .WithMany()
